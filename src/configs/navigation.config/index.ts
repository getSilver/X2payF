...
import { APP_PREFIX_PATH, MER_PREFIX_PATH } from '@/constants/route.constant'
 ...
 */
export const getNavigationConfig = (pathname: string): NavigationTree[] => {
    if (pathname.startsWith(MER_PREFIX_PATH)) {
        return merNavigation
    }
